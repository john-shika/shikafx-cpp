...
#define skx_cast_str_to_byte_stack skfx_ext_mod::cast_str_to_byte_stack
#define skx_cast_str_to_data skfx_ext_mod::cast_str_to_data
#define skx_copy_str_to_byte_stack skfx_ext_mod::copy_str_to_byte_stack
#define skx_copy_str_to_char_stack skfx_ext_mod::copy_str_to_char_stack
#define skx_copy_str_to_data skfx_ext_mod::copy_str_to_data
#define skx_cast_data_to_byte_stack skfx_ext_mod::cast_data_to_byte_stack
#define skx_copy_data_to_byte_stack skfx_ext_mod::copy_data_to_byte_stack
#define skx_copy_data_to_char_stack skfx_ext_mod::copy_data_to_char_stack
...
namespace skfx_ext_mod {
    ...
    auto copy_str_to_char_stack(const std::string& val) -> char*;
    auto copy_str_to_data(const std::string& val) -> const data_t*;
    auto cast_data_to_byte_stack(const data_t* data) -> const byte_t*;
    auto copy_data_to_byte_stack(const data_t* data) -> byte_t*;
    auto copy_data_to_char_stack(const data_t* data) -> char*;
